...
## 🏎️ 更新详情
会不断对版本进行优化，并在海航官方发布新航表时维护更新数据（`v0822f`中`0822`为航班数据截断日期，`f`为版本名）。
- **数据更新**
  ...
  - `v0910`及以后版本源于海航官方在飞飞乐APP发布的数据（最新数据截至2025.09.30），该数据没有到达时刻和机型信息，在此做了补充（没有参考意义）。
  - `v0930`海航官方在2025.09.30发布冬春航季数据，自己整理的[v0930夏秋航线文档](https://www.kdocs.cn/l/cqy1AfiQ4Gcx)、[v0930冬春航线文档](https://www.kdocs.cn/l/cqeWjFOoTyN7)可供所有人查看、复制、保存。
...
本项目使用 [OpenStreetMap] / [高德地图](默认) 作为底图。
